...
<!-- Mirrored from 160.153.129.104/forestJackson/whitewine.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 16 Apr 2018 09:26:49 GMT -->
<head>
...
<div class="container">
     <div class="row">
      <div class="col-md-12">
        <a class="#" href="#"> <img src="img/image%20(2).jpg" alt="image (2)" style="width: 100%; height: 100%"></a>
      </div> 
     </div> 
    </div>
    <div class="container">
     <div class="row">
      <div class="col-md-12">
      <h2 style="text-align: center;">Standard Red</h2>
          <hr style="background: #9b635e;display: block;width: 20%;height: 2px;text-align: center;margin-top: 0px;">
        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer Lorem Ipsum Lorem Ipsum is simply dummy text of the printing and typesetting industry Lorem Ipsum has.</p>
      </div> 
     </div> 
    </div>

...
<div>
  ...
  <div class="container">
   <div class="row">
    <div class="col-md-12">
     <a class="link" href="#"> <img src="img/DSC_3386.jpg" alt="DSC_3386.jpg" class="zse" style="width: 50%;"></a>
      <br>
      <br>
      <h4 style="text-align: center;font-size:bold;">HIRWA SAMUEL</h4>
      <br>
        <hr style="background: #9b635e;display: block;width: 35%;height: 2px;text-align: center;margin-top: 0px;">
      <p>Hirwa is as an eager real estate agent who works hard to ensure that the needs of his clients are met. This part-time university student has a charming demeanour and knows the art of listening. Born and raised in Kigali, Hirwa is intimately familiar with the lay of the land and can provide insights into the local environment and customs as only a local can. Sam is currently a student of the College of Science and Technology.

      <br>Languages spoken: English, French, Kinyarwanda, Swahili. <br><b style="color: #9b635e;">samuel@fj-properties.com | +250 788 903 839</b></p> 
    </div> 
   </div> 
  </div>
<br><br>				

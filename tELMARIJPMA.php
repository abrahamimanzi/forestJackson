...
<div>
	...
	<!--/banner-info-->
	   <div class="header">
        ...
        <div class="no-padding">
          <a class="#" href="index.php"> <img src="img/banner.gif" alt="#" style="width: 100%; "></a>
        </div>
		<br>
      </div>
    </div>
  ...
  <div class="container">
   <div class="row">
    <div class="col-md-12">
     <a class="link" href="#"> <img src="img/DSC_9891.jpg" alt="forrest_jackson-03" class="zse" style="width: 50%;"></a>
      <br>
      <br>
      <h4 style="text-align: center;font-size:bold;">TELMA RIJPMA</h4>
      <br>
        <hr style="background: #9b635e;display: block;width: 35%;height: 2px;text-align: center;margin-top: 0px;">
      <p>Telma, from the Republic of Seychelles, has a background in business and accounting. An expat for the last 24 years, Telma has resided and worked in The Netherlands, Bangladesh, Malawi, Vietnam and Seychelles. Her travels have provided her with opportunities to interact with people from all over the world. Professional, knowledgeable, and courteous, this relocation veteran will work with you to find the right home in Kigali, and will provide you with insights that can help make your overall relocation experience a pleasant one.<br><br>Telma speaks English, French, Dutch and Creole.<br><b style="color:#9b635e;">telma@fj-properties.com | +250 785 925 033 </b></p>  
    </div> 
   </div> 
  </div>
<br><br>				
...
<!-- Mirrored from 160.153.129.104/forestJackson/moreNatalie.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 16 Apr 2018 09:26:49 GMT -->
</html>
...
<div>
  ...
  <div class="container">
   <div class="row">
    <div class="col-md-12">
     <a class="link" href="#"> <img src="img/DSC_3399.jpg" alt="DSC_3399.jpg" class="zse" style="width: 50%;"></a>
      <br>
      <br>
      <h4 style="text-align: center;font-size:bold;"> JEAN DE DIEU KARANGWA </h4>
      <br>
      <hr style="background: #9b635e;display: block;width: 35%;height: 2px;text-align: center;margin-top: 0px;">
      <p>Jean de Dieu is akin to a hunter. He knows how to find that property which no one knew existed. A quiet individual who loves what he does.

      <br>Languages spoken: English, French and Kinyarwanda <br><b style="color: #9b635e;">jean@fj-properties.com | +250 788 529 702</b></p> 
    </div> 
   </div> 
  </div>
    <br><br>        
...
<div class="footer">
    <div class="container">
      <div class="social">
        <ul>
          <li><a href="https://web.facebook.com/ForrestJacksonRelo/"><i class="fa fa-facebook"></i></a></li>
          <li><a href="https://twitter.com/MoveToKigali?s=03"><i class="fa fa-twitter"></i></a></li>
        </ul>
      </div>

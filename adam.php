...
<div>
  ...
  <div class="container">
   <div class="row">
    <div class="col-md-12">
     <a class="link" href="#"> <img src="img/DSC_3410.jpg" alt="DSC_3410" class="zse" style="width: 50%;"></a>
      <br>
      <br>
      <h4 style="text-align: center;font-size:bold;">Adam Kanimba</h4>
      <br>
        <hr style="background: #9b635e;display: block;width: 35%;height: 2px;text-align: center;margin-top: 0px;">
      <p>
		Adam is a knowledgeable agent with an ability to find the right place for each client. He takes the need of each client seriously and listens to their wishes while providing professional guidance. Adam is a graduate of the College of Science and Technology.<br><br>
		Languages spoken: English, French, Kinyarwanda, Swahili <br><b style="color:#9b635e;">adam@fj-properties.com | +250 785 363 412</b></p>  
    </div> 
   </div> 
  </div>
<br><br>				

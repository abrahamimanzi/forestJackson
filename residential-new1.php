...
<!-- Mirrored from 160.153.129.104/forestJackson/residential.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 16 Apr 2018 09:19:55 GMT -->
<head>
<title>Ridential</title>
<!-- custom-theme -->
...
<div class="popular-w3">
	<div class="container">
		<h2 class="tittle">Featured Residential Properties</h2>
		<div class="popular-grids">
			...
			<div class="col-md-4 popular-grid">
				...
				<div class="popular-grid-box">
					<img src="img/properties/<?=$image?>" class="img-responsive" alt=""/>
					<div class="popular-text">
						<h5><?php echo $title; ?></h5>
						<a href="#" class="button btn-prop"><?php echo $price; ?></a>
						<div class="detail-bottom">
							<p><?php echo $substr; ?>...</p>
							
							<ul>
								<li class="text-info">Bedrooms</li>
								<li class="text-info1"><?php echo $bedroom; ?></li>
								<div class="clearfix"></div>
							</ul>
							<ul>
								<li class="text-info">Bathrooms</li>
								<li class="text-info1"><?php echo $bathroom; ?></li>
								<div class="clearfix"></div>
							</ul>
							<ul>
								<li class="text-info">Location</li>
								<li class="text-info1"><?php echo $location; ?></li>
								<div class="clearfix"></div>
							</ul>
						</div>
					</div>

...
<!-- Mirrored from 160.153.129.104/forestJackson/rentingProperty.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 16 Apr 2018 09:26:36 GMT -->
<head>
...
<!-- about section -->
	<div class="row no-padding">
		...
		<a class="#" href="residential.php"> <img src="img/black.jpg" alt="12" style="max-width: 100%;"> </a>	
	</div>	
</div>
<!--// about -->
	...
	<section class="#" style="padding: 15px;">
      <div class="container">
        <div class="row no-margin">
         <div class="col-md-12">
         <h3 class="sell" style="padding-left: 40px;padding-right: 40px;padding-bottom: 30px;text-align: center;font-size: 30px;color: #9b635e;"> Renting your Property</h3>
         <hr style="background: #9b635e;display: block;width: 30%;height: 2px;text-align: center;margin-top: 0px;">
         <p>
           Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer Lorem Ipsum Lorem Ipsum is simply dummy text of the printing and typesetting industry Lorem Ipsum has.
          </p> 
         </div> 
        </div>
      </div>
      ...
      <div class="container">
         <div class="row no-margin">
             <div class="col-md-12 no-padding">
               <form action="http://golothemes.com/themes/engage/php/contact.php" method="post" id="contactform" class="contact-form clearfix">
                    <!--Input Field-->
                    <div class="form-group">
                      <div class="col-md-12 visible input-group">
                    ...
                    <div class="row">
                      <div class="col-md-12 "> 
                        ...
                        <div class="form-group">
                          <div class="col-md-12 visible input-group">
                            <textarea class="form-control" rows="6" id="comments" name="comments" placeholder="Message"></textarea>
                          </div>
                          <!--/ Input Field--> 
                        </div>
                      </div>
                      <div class="col-md-4 col-sm-7 col-xs-9"> 
                        ...
                        <div class="form-group text-right">
                           <a href="residential.php" class="btn-mc btn">Send your Message</a> 
                        </div>
                        <!--/ Input Field--> 
                      </div>
                    </div>
...
<!-- Mirrored from 160.153.129.104/forestJackson/rentingProperty.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 16 Apr 2018 09:26:44 GMT -->
</html>
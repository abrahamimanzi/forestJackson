...
<div>
  ...
  <div class="container">
   <div class="row">
    <div class="col-md-12">
     <a class="link" href="#"> <img src="img/forrest_jackson-04.jpg" alt="forrest_jackson-04" class="zse" style="width: 50%;"></a>
      <br>
      <br>
      <h4 style="text-align: center;font-size:bold;">FLORA UWAYEZU</h4>
      <br>
          <hr style="background: #9b635e;display: block;width: 35%;height: 2px;text-align: center;margin-top: 0px;">
      <p>Flora has a pleasant demeanour and an eagerness to satisfy every customer. This College of Science and Technology major is completing her studies while working hard to be a star real estate agent.
      Languages spoken: Kinyarwanda, French and English</p>  
    </div> 
   </div> 
  </div>
		<br><br>				

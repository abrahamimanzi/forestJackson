...
<div>
										...
										<div class="book-form">
										   <form action="#" method="post">
												...
												<div class="col-md-2 col-xs-12 form-left-agileits-submit" style="padding-right: 0;">
														<!-- <label><i class="fa fa-home" aria-hidden="true"></i> Category</label> -->
														<button type="button" class="btn btn-info" data-toggle="collapse" data-target="#demo" style="padding: .7em;font-size: 14px;">More Filters</button>
												</div>
 ...
 <div class="container">
     ...
     <div class="row no-margin">
      <div class="col-md-12 no-padding">
        <a class="#" href="#"> <img src="img/stock3.jpg" alt="stock3" style="width: 100%;height: 90%;"></a>
      </div> 
     </div> 
    <div class="container">
     <div class="row">
      <div class="col-md-3">
        <a class="#" href="redwine.php"> <img src="img/image%20(1).jpg" alt="image (1)" style="width: 100%;"></a>
        <div class="light">
          <a class="#" href="redwine.php"><h2>Standard Red</h2></a>
          <p>Lorem Ipsum has been the industry's standard dummy text</p>
        </div>
      </div>
      <div class="col-md-3">
        <a class="#" href="whitewine.php"> <img src="img/image%20(2).jpg" alt="image (2)" style="width: 100%;"></a>
        <div class="light">
          <a class="#" href="whitewine.php"><h2>Large bordeaux</h2></a>
          <p>Lorem Ipsum has been the industry's standard dummy text</p>
        </div>
      </div> 
      <div class="col-md-3">
        <a class="#" href="sodaGlasses.php"> <img src="img/image%20(3).jpg" alt="image (3)" style="width: 100%;"></a>
        <div class="light">
          <a class="#" href="sodaGlasses.php"><h2>Tumbler</h2></a>
          <p>Lorem Ipsum has been the industry's standard dummy text</p>
        </div>
      </div> 
      <div class="col-md-3">
        <a class="#" href="plate.php"><img src="img/image%20(4).jpg" alt="image (4)" style="width: 100%;"></a>
        <div class="light">
           <a class="#" href="plate.php"><h2>Dinner plate</h2></a>
          <p>Lorem Ipsum has been the industry's standard dummy text</p>
        </div>
      </div>  
     </div> 
...
<!-- Mirrored from 160.153.129.104/forestJackson/equipmentRentals.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 16 Apr 2018 09:16:10 GMT -->
</html>
...
<div>
  ...
  <div class="container">
   <div class="row">
    <div class="col-md-12">
     <a class="link" href="#"> <img src="img/DSC_3419.jpg" alt="DSC_3419.jpg" class="zse" style="width: 50%;"></a>
      <br>
      <br>
      <h4 style="text-align: center;font-size:bold;">Jean Luc Musabeyezu</h4>
      <br>
        <hr style="background: #9b635e;display: block;width: 35%;height: 2px;text-align: center;margin-top: 0px;">
      <p>
		Jean Luc has a deep understanding of the neighbourhoods of Kigali and will find just the commercial or residential place you are looking for. His quiet but pleasant demeanour makes him a joy to work with. Jean Luc is a graduate of the College of Science and Technology.<br>
		Languages spoken: English, French, Kinyarwanda<br><b style="color:#9b635e;">jeanluc@fj-properties.com | +250 782 516 757 </b></p>  
    </div> 
   </div> 
  </div>
		<br><br>				
